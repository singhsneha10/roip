...
class OrderEvent:
    ...
    occurred_at:   int   = field(default_factory=lambda: int(datetime.utcnow().timestamp() * 1000))
    ingested_at:   int   = field(default_factory=lambda: int(datetime.utcnow().timestamp() * 1000))
